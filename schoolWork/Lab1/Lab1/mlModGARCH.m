function [xOpt, ll] = mlModGARCH(r,dt,x1)
...
[xOpt,f,exitflag,output,lambda,grad,hessian] = fmincon(@(x) negLikelihoodNormal(x,r,dt,@varModGARCH),x0,A,b,[],[],lb,ub,[],optionvec);

ll = likelihoodNormal(xOpt,r,dt,@varModGARCH);
