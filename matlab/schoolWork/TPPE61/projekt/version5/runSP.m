...
dt = 1/252;
t = 1/52;           % Time for Monte-Carlo simulations
tUpdate = 1/4;
...
[rhoStudT, df, sigma, xOpt] = estParamsForModel(dates, rKal, dt, nDates - simLength, estPeriodVol);
...
%         scenarioPrices = logRetToPricesForSP(pKal(curDate,:),scenarioReturns);
